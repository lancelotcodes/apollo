...
namespace apollo.Infrastructure.Migrations
{
    ...
    [Migration("20221112122100_changedforeignkeyrelationfordocument")]
    partial class changedforeignkeyrelationfordocument
    {
            ...
            modelBuilder.Entity("apollo.Domain.Entities.Core.PropertyDocument", b =>
                {
                    b.HasOne("apollo.Domain.Entities.Core.Document", "Document")
                        ...
                        .HasPrincipalKey("apollo.Domain.Entities.Core.Document", "DocumentKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
