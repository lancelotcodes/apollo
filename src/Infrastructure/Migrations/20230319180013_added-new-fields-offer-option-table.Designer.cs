...
namespace apollo.Infrastructure.Migrations
{
    ...
    [Migration("20230319180013_added-new-fields-offer-option-table")]
    partial class addednewfieldsofferoptiontable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("apollo.Domain.Entities.Core.OfferOption", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("HandOverConditionID")
                        .HasColumnType("int");
                    ...
                    b.ToTable("OfferOptions");
                });

            modelBuilder.Entity("apollo.Domain.Entities.Core.OfferUnit", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("apollo.Domain.Entities.Core.OfferUnit", b =>
                {
                    b.HasOne("apollo.Domain.Entities.Core.OfferOption", "OfferOption")
                        .WithMany("OfferUnits")
                        .HasForeignKey("OfferId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("apollo.Domain.Entities.Core.Unit", "Unit")
                        .WithMany()
                        .HasForeignKey("UnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OfferOption");
            ...
            modelBuilder.Entity("apollo.Domain.Entities.Core.PropertyAgent", b =>
                {
                    b.HasOne("apollo.Domain.Entities.Core.Contact", "Agent")
                        .WithMany()
            ...
            modelBuilder.Entity("apollo.Domain.Entities.Core.Unit", b =>
                {
                    ...
                    b.HasOne("apollo.Domain.Entities.Core.Property", "Property")
                        .WithOne()
                        .HasForeignKey("apollo.Domain.Entities.Core.Unit", "PropertyID");
